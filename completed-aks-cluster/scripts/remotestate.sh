...
location="eastus"
tfstatename_container="tftstatevnetdev01"
KEYVAULT="argocd-tfs-kvault" # Parameter 'vault_name' must conform to the following pattern: '^[a-zA-Z0-9-]{3,24}$'.
KEYVAULTSECRET="vnettfstatesecret" 
KEY="vnet_dev.tfstate" # i.e. "vnet_appappgtw_terraform.tfstate"  - make sure naming convention follows after resources being built by terraform
